        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 mb-8">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={isAdding}
              className={`px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all relative ${isAdding ? 'opacity-70 cursor-not-allowed pl-8' : ''}`}
            >
              {isAdding && (
                ...
                {categories.map(category => (
                  <div key={category} className="flex items-center justify-between bg-gray-50 dark:bg-gray-900 p-3 rounded-md">
                    ...
                    <button
                      ...
                      className={`text-red-500 hover:text-red-700 p-1 rounded relative ${deletingCategory === category ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
