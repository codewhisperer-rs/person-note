...
export function TechAnchors() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-1/4 right-20 w-2 h-2 bg-green-500 rounded-full animate-ping opacity-70" style={{animationDuration: '4s'}} />
      <div className="absolute bottom-1/3 left-1/4 w-2 h-2 bg-purple-500 rounded-full animate-ping opacity-70" style={{animationDuration: '5s'}} />
      <div className="absolute bottom-20 right-1/3 w-2 h-2 bg-cyan-500 rounded-full animate-ping opacity-70" style={{animationDuration: '3.5s'}} />
    </div>
  );
}
